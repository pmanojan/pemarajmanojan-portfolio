...
END:VCARD`;
  ...
  function initCommandPalette() {
    ...
    const commands = [
      ...
      { label: 'Go to Services', icon: 'fa-concierge-bell', action: () => scrollToSection('#services') },
  ...
  function initKeyboardNav() {
    ...
    document.addEventListener('keydown', (e) => {
      ...
      if (num >= 1 && num <= 9) {
        const sections = ['#home', '#about', '#services', '#experience', '#skills', '#certifications', '#projects', '#contact'];
        if (sections[num - 1]) {
